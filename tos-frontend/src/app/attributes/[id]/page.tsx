        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 font-mono text-gray-900 font-semibold">{attribute.id}</span>
            </div>
            <div>
              <span className="text-gray-600">IDS:</span>
              <span className="ml-2 font-mono text-gray-900 font-semibold">{attribute.ids}</span>
            </div>
            <div>
              <span className="text-gray-600">생성일:</span>
              <span className="ml-2 text-gray-800">{new Date(attribute.created || attribute.created_at || '').toLocaleDateString('ko-KR')}</span>
            </div>
            <div>
              <span className="text-gray-600">수정일:</span>
              <span className="ml-2 text-gray-800">{new Date(attribute.updated || attribute.updated_at || '').toLocaleDateString('ko-KR')}</span>
            </div>
          </div>
        </div>
      </div>
